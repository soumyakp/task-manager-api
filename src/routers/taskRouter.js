...
router.patch('/tasks/:id', auth, async (req, res) => {
  ...
  const taskAllowedUpdate = ['title', 'description', 'status'];
  const taskIsValidOperation = taskUpdates.every(taskEachProperty =>
    taskAllowedUpdate.includes(taskEachProperty)
  );
  ...
  try {
    ...
    taskUpdates.forEach(
      taskEachProperty => (task[taskEachProperty] = req.body[taskEachProperty])
    );
    task.save();
